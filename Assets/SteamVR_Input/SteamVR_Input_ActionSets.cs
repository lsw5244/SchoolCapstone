...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_CustomeSet p_CustomeSet;
        ...
        public static SteamVR_Input_ActionSet_CustomeSet CustomeSet
        {
            get
            {
                return SteamVR_Actions.p_CustomeSet.GetCopy<SteamVR_Input_ActionSet_CustomeSet>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_CustomeSet = ((SteamVR_Input_ActionSet_CustomeSet)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_CustomeSet>("/actions/CustomeSet")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.CustomeSet};
        }
    }
}
